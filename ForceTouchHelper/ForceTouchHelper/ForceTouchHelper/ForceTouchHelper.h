...
/**
 ...
 @param indexPath 传入的目录值，若传入为TableView或CollectionView，则为对应的indexpath，若传入NSArray<UIView *> 则section = 0,row为对应的序号.
...
/**
 ...
 @param callBack 根据IndexPath 返回要跳转的控制器，返回nil则当前cell不使用ForceTouch.
